  ...
  if ($accessKey && $category) {
    if (isAccessKeyValid($db, $accessKey)) {
      $query =
        ...
        "             cpi_player.playerName1, cpi_player.playerNameOnly1, cpi_player.playerRanking1, cpi_player.playerClub1," .
        "             cpi_player.playerName2, cpi_player.playerNameOnly2, cpi_player.playerRanking2, cpi_player.playerClub2" .
        " FROM        cpi_player" .
